   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php 
            ...
            $number_of_orders = mysqli_num_rows($select_orders); //function() returns the number of rows in a result set.
         ?>
      ...
      <div class="box">
         <?php 
            ...
            $number_of_products = mysqli_num_rows($select_products);//function() returns the number of rows in a result set.
         ?>
